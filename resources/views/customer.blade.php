...
<body class="antialiased bg-gray-700">
    ...
    <div class="container flex justify-center px-5 py-5">
        <div class="bg-gray-100 w-3/4 h-3/4 py-5">
            <h2 class="text-blue-700 text-2xl text-center mb-5">Customer Registration</h2>
            <form class="mx-5" action="{{route('customer.store')}}" method="post">
                @csrf
                <div class="flex mb-5">
                    <div class="flex flex-col w-full mr-5">
                        <label class="mb-3 text-gray-700">Name: <span class="text-red-500">*</span></label>
                        <input class="border border-gray-200 shadow-sm w-full pl-2 py-1" type="text" placeholder="Your Name" name="name" />
                ...
                <div class="flex mb-5">
                    <div class="flex flex-col w-full mr-5">
                        ...
                        <input class="border border-gray-200 shadow-sm w-full pl-2 py-1 outline-2 outline-offset-2" type="text" placeholder="Your Country" name="country" />
                    </div>
                    <div class="flex flex-col w-full">
                        <label class="mb-3 text-gray-700">State:</label>
                        <input class="border border-gray-200 shadow-sm w-full pl-2 py-1 outline-2 outline-offset-2" type="text" placeholder="Your State" name="state" />
                    </div>
                </div>
                <div class="flex mb-5">
                    <div class="flex flex-col w-full">
                        <label class="mb-3 text-gray-700">Address:</label>
                        <input class="border border-gray-200 shadow-sm w-full pl-2 py-1 outline-0 hover:outline-2 hover:outline-dotted hover:outline-zinc-500" type="textarea" placeholder="Your Address" name="address" />
                    </div>
                </div>
                <div class="flex mb-5">
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex w-full mr-5 justify-left items-center mt-3">
                            <input class="border border-gray-200 shadow-sm mr-2" type="radio" value="M" name="gender" /><span class="mr-2">Male</span>
                            <input class="border border-gray-200 shadow-sm mr-2" type="radio" value="F" name="gender" /><span class="mr-2">Female</span>
                            <input class="border border-gray-200 shadow-sm mr-2" type="radio" value="O" name="gender" /><span class="mr-2">Other</span>
                        </div>
                    </div>
                    <div class="flex flex-col w-full">
                        <label class="mb-3 text-gray-700">Date of Birth:</label>
                        <input class="border border-gray-200 shadow-sm w-full pl-2 py-1 outline-0" type="date" placeholder="Date of Birth" name="dob" />
                    </div>
                </div>
